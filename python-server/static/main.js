...
module.exports = "#stocks {\n  margin: 50px 0 0 0; }\n\n#searchStock {\n  margin: 10px 0 0 0; }\n\n#searchBar {\n  margin: 10px 0 0 0; }\n\nbody div {\n  display: flex;\n  width: 100%; }\n\nbody div p {\n  margin: 0 20px 0 0; }\n\nbutton {\n  margin: 0 5px 0 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var BuySellComponent = /** @class */ (function () {
    ...
    BuySellComponent.prototype.sellStockButton2 = function (symbol) {
        if (Number.isInteger(this.shares) != true || this.shares == 0 || Math.sign(this.shares) == -1) {
            ...
            this.stocks.updateBalanceSell(symbol, this.accountId, this.shares).subscribe(function (data) {
            });
            this.stocks.transactions(this.accountId, symbol, this.type, this.shares).subscribe(function (data) { });
            this.shares = 0;
        }
    ...
    BuySellComponent.prototype.buyStockButton3 = function () {
        if (Number.isInteger(this.shares) != true || this.shares == 0 || Math.sign(this.shares) == -1) {
            ...
            this.stocks.updateBalanceBuy(this.searchStockSymbol, this.accountId, this.shares).subscribe(function (data) {
            });
