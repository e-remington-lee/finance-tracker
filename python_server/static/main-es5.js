...
var AccountComponent = /** @class */ (function () {
    function AccountComponent(data, auth) {
        this.data = data;
        this.auth = auth;
...
var AuthService = /** @class */ (function () {
    ...
    Object.defineProperty(AuthService.prototype, "accessRoute", {
        get: function () {
            var x = sessionStorage.getItem('Authorization');
            if (x == null || x == undefined || x == '') {
                return false;
            }
            var y = jwt_decode__WEBPACK_IMPORTED_MODULE_2__(x);
            var date = new Date(0);
            var tokenDate = date.setUTCSeconds(y.exp);
    ...
    AuthService.prototype.decodeUser = function () {
        var x = sessionStorage.getItem('Authorization');
        var y = jwt_decode__WEBPACK_IMPORTED_MODULE_2__(x);
        return y;
    };
...
var BuyModalComponent = /** @class */ (function () {
    function BuyModalComponent(stocks, data, ngbActiveModal, auth) {
        this.stocks = stocks;
        this.data = data;
    ...
    BuyModalComponent.prototype.buyStockButton = function () {
        var _this = this;
        if (Number.isInteger(this.shares) != true || this.shares == 0 || Math.sign(this.shares) == -1) {
            ...
            this.data.checkBalance(this.symbol[0]['symbol'], this.accountId, this.shares).subscribe(function (resp) {
                if (resp.status == 200) {
                    _this.symbol[0]['type'] = 'buy';
                    _this.symbol[0]['accountId'] = _this.accountId;
                    _this.symbol[0]['shares'] = _this.shares;
                    console.log(_this.symbol);
                    _this.stocks.buyStock2(_this.symbol).subscribe();
                    _this.stocks.updateBalanceBuy(_this.symbol).subscribe();
                    _this.stocks.transactions(_this.symbol).subscribe();
                    _this.shares = 0;
                    alert("Successful Purchase of " + _this.symbol[0]['shares'] + " Shares(s) of " + _this.symbol[0]['company']);
                }
            }, function (error) {
    ...
    BuyModalComponent.prototype.closeModal = function () {
        this.ngbActiveModal.close();
    };
    BuyModalComponent.ctorParameters = function () { return [
...
var BuySellComponent = /** @class */ (function () {
    function BuySellComponent(stocks, data, auth) {
        this.stocks = stocks;
        this.data = data;
        this.auth = auth;
        this.SPY = [];
    ...
    BuySellComponent.prototype.ngOnInit = function () {
        ...
        this.data.returnStocks('SPY').subscribe(function (data) {
            _this.SPY = data;
        });
        this.data.returnStocks('DIA').subscribe(function (data) {
            _this.DIA = data;
        });
        this.data.returnStocks('IWM').subscribe(function (data) {
            _this.IWM = data;
    ...
    BuySellComponent.prototype.searchStocks = function () {
        ...
        this.data.returnStocks(this.searchStockSymbol).subscribe(function (data) {
            ...
            if (error.status === 500 || error.status === 404) {
                alert(_this.searchStockSymbol + " was not found");
            }
        });
    };
    BuySellComponent.prototype.updateChart = function () {
        ...
        this.data.chartData(this.searchStockSymbol).subscribe(function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                _this.lableList.push(data[i].label);
            }
            for (var y = 0; y < data.length; y++) {
                _this.priceList.push(data[y].average);
            }
            ...
            _this.chart.options.title.text = "Daily Prices For " + _this.searchStockSymbol + " on " + data[0].date + " ";
            _this.chart.update();
        });
    };
    BuySellComponent.ctorParameters = function () { return [
        { type: _stocks_service__WEBPACK_IMPORTED_MODULE_2__["StocksService"] },
        { type: _data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] },
        { type: _auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }
    ]; };
...
var DataService = /** @class */ (function () {
    ...
    ;
    DataService.prototype.getAccountData = function (accountId) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('accountId', accountId) };
    ...
    DataService.prototype.login = function (email, password) {
        ...
        var options = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](content) };
        return this.http.get('http://localhost:7000/api/login', options);
    };
    DataService.prototype.register = function (content) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.openLoginModal = function () {
        var modal = this.modalService.open(_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"]);
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(data, router, ngbActiveModal) {
        this.data = data;
        this.router = router;
        this.ngbActiveModal = ngbActiveModal;
    }
    ...
    LoginComponent.prototype.register = function () {
        ...
        var myPromise = new Promise(function (resolve, reject) {
            if (_this.password === _this.password2 && _this.password.length >= 6 && _this.email !== undefined && _this.email.includes("@")
                && _this.firstName !== undefined && _this.lastName !== undefined) {
                var content = {
                ...
                resolve(_this.data.register(content).subscribe(function (data) {
                    console.log("Registering..." + data);
                    _this.login();
                }, function (error) {
                    if (error.status === 401) {
                        _this.registerError = 'Email already exists';
                    }
                }));
            }
            else if (_this.email.includes("@") === false) {
                reject(_this.registerError = "Email required");
            }
            else if (_this.password !== _this.password2) {
                reject(_this.registerError = 'Passwords do not match');
            }
            else if (_this.password.length < 6) {
                reject(_this.registerError = 'Password must be at least 6 characters long');
            }
            else {
                reject(_this.registerError = 'All inputs required');
            }
        });
        myPromise.then(function () { return _this.login(); }).catch(function () { return console.log('Bad Login'); });
    };
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.data.login(this.email, this.password).subscribe(function (data) {
            _this.ngbActiveModal.close();
            console.log('Logged in!');
            sessionStorage.setItem('Authorization', data['token']);
            _this.router.navigate(['rulesRanking']);
            location.reload();
        }, function (error) {
            if (error.status === 401) {
    ...
    LoginComponent.prototype.rulesPage = function () {
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.renameAccount = function () {
        try {
            this.default = this.auth.decodeUser()['first_name'];
        }
        catch (error) {
...
var PortfolioCardComponent = /** @class */ (function () {
    function PortfolioCardComponent(buySell, router) {
    ...
    PortfolioCardComponent.prototype.trade = function () {
    ...
    PortfolioCardComponent.ctorParameters = function () { return [
...
var PortfolioComponent = /** @class */ (function () {
    function PortfolioComponent(stocks, data, auth) {
        this.stocks = stocks;
        this.data = data;
        this.auth = auth;
        this.accountData = [];
    ...
    PortfolioComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getAccountData(this.accountId).subscribe(function (data) {
            _this.accountData = data;
            console.log(_this.accountData['asset_data']);
            console.log(_this.accountData['asset_values']);
            console.log(_this.accountData);
            _this.assetData = _this.accountData['asset_data'];
            _this.assetValues = _this.accountData['asset_values'];
            var companyName = [];
            var holdingValue = [];
            var color = [];
            for (var x = 0; x < _this.assetData.length; x++) {
                companyName.push(_this.assetData[x]['company']);
                holdingValue.push(_this.assetData[x]['holding_value_float']);
                color.push("#3e95cd");
            }
...
var RulesRankingComponent = /** @class */ (function () {
    function RulesRankingComponent() {
    }
    RulesRankingComponent.prototype.ngOnInit = function () {
    };
...
var SellModalComponent = /** @class */ (function () {
    function SellModalComponent(stocks, data, ngbActiveModal, auth) {
        this.stocks = stocks;
        this.data = data;
        this.ngbActiveModal = ngbActiveModal;
        this.auth = auth;
    ...
    SellModalComponent.prototype.sellStockButton = function () {
        var _this = this;
        if (Number.isInteger(this.shares) != true || this.shares == 0 || Math.sign(this.shares) == -1) {
            alert('Must be a positive whole number');
            this.ngbActiveModal.close();
            ...
            this.data.checkStock(this.symbol[0]['symbol'], this.accountId, this.shares).subscribe(function (resp) {
                if (resp.status == 200) {
                    _this.symbol[0]['accountId'] = _this.accountId;
                    _this.symbol[0]['shares'] = _this.shares;
                    _this.symbol[0]['type'] = 'sell';
                    _this.stocks.sellStock(_this.symbol).subscribe();
                    _this.stocks.updateBalanceSell(_this.symbol).subscribe();
                    _this.stocks.transactions(_this.symbol).subscribe();
                    _this.shares = 0;
                    alert("Successfully sold " + _this.symbol[0]['shares'] + " Shares(s) of " + _this.symbol[0]['company']);
                }
            }, function (error) {
                if (error.status == 404 || error.status === 500) {
    ...
    SellModalComponent.prototype.closeModal = function () {
        this.ngbActiveModal.close();
    };
    SellModalComponent.ctorParameters = function () { return [
        { type: _stocks_service__WEBPACK_IMPORTED_MODULE_2__["StocksService"] },
        { type: _data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbActiveModal"] },
        { type: _auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }
...
var StockCardComponent = /** @class */ (function () {
    function StockCardComponent(modalService) {
        this.modalService = modalService;
        this.symbol = [];
    }
    StockCardComponent.prototype.ngOnInit = function () {
    };
    StockCardComponent.prototype.openBuyModal = function () {
        var modal = this.modalService.open(_buy_modal_buy_modal_component__WEBPACK_IMPORTED_MODULE_3__["BuyModalComponent"]);
        modal.componentInstance.symbol = this.symbol;
    };
    StockCardComponent.prototype.openSellModal = function () {
        var modal = this.modalService.open(_sell_modal_sell_modal_component__WEBPACK_IMPORTED_MODULE_4__["SellModalComponent"]);
        modal.componentInstance.symbol = this.symbol;
    };
    StockCardComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
