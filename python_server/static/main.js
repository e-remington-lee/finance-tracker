...
module.exports = "<div class='card'>\n    <div class='card-body'>\n      <div class='show-hide-md row'>\n      <div class='col-lg-3 col-md-12 rightBorder marginSpace' id=stockHeader>\n          <b>{{stock.company}} : {{stock.symbol}}</b>\n      </div>\n      <div class='col-lg-7 col-md-12 marginSpace'>\n          <p class= 'rightBorder'><b>Holding Value: </b> ${{stock.holding_value}}</p>\n          <p class= 'rightBorder'><b>Shares: </b> {{stock.shares}}</p>\n          <p class= 'rightBorder'><b>Last Price: </b> ${{stock.current_price}}</p>\n          <p><b>Percent Change: </b> {{stock.percent_change}}%</p>  \n      </div>\n      <div class='col-lg-2 col-md-12 marginSpace'>\n        <button type='submit' class='btn btn-primary' (click)='trade()'>Trade</button>\n      </div>\n    </div>\n    </div>\n  </div>\n"
...
module.exports = "<div class='card'>\n  <div class='card-body'>\n    <div class='show-hide-md row'>\n    <div class='col-lg-3 col-md-12 rightBorder marginSpace' *ngFor='let stock of symbol'  id='stockHeader'>\n        <b>{{stock.company}} : {{stock.symbol}}</b>\n    </div>\n    <div class='col-lg-7 col-md-12 marginSpace' *ngFor='let stock of symbol' id='stockInfo'>\n        <p class='rightBorder'><b>Current Price:</b> ${{stock.price}}</p>\n        <p class='rightBorder'><b>Percent Change:</b> {{stock.changePercent}}% </p>\n        <p ><b>Daily Gain/Loss:</b> ${{stock.change}} </p>       \n    </div>\n    <div class='col-lg-2 col-md-12 marginSpace' id='stockButton'>\n        <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#buyStock' (click)='openBuyModal()'>Buy</button>\n        <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#sellStock' (click)='openSellModal()'>Sell</button>\n      </div>\n\n    </div>\n  </div>\n</div>"
...
/* harmony import */ var _buy_sell_buy_sell_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./buy-sell/buy-sell.component */ "./src/app/buy-sell/buy-sell.component.ts");
...
module.exports = "#stocks {\n  margin: 50px 0 50px 0;\n}\n\n#searchStock {\n  margin: 10px 0 0 0;\n}\n\n#searchBar {\n  margin: 20px 0 0 0;\n}\n\nbody div {\n  display: flex;\n  width: 100%;\n}\n\nbody div p {\n  margin: 0 20px 0 0;\n}\n\nbutton {\n  margin: 0 5px 0 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#showcase {\n  background: url(\"/static/assets/homePageImage.jpg\");\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n  height: 100vh;\n  justify-content: center;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\nheader div {\n  width: 50%;\n  background-color: rgba(137, 137, 146, 0.5);\n  align-items: center;\n  justify-content: center;\n  font-size: 20px;\n}\n\ndiv button {\n  font-size: 20px;\n  margin: 0 5px 5px 5px;\n}\n\nfooter {\n  margin: 0 0 0 30px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "a {\n  cursor: pointer;\n}\n\n#loginRoute {\n  color: royalblue;\n}\n\n#register {\n  color: royalblue;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "div {\n  display: flex;\n  width: 100%;\n}\n\n.rightBorder {\n  padding-right: 10px;\n  border-right: 1px solid #ccc;\n}\n\ndiv p {\n  margin: 0 5px 0 0;\n}\n\nbutton {\n  margin: 0 5px 0 0;\n}\n\n@media only screen and (max-width: 992px) {\n  #stockHeader {\n    border-right: 0px;\n  }\n\n  .marginSpace {\n    justify-content: center;\n    margin: 10px 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#account {\n  margin: 20px 0 0 0;\n}\n\n#portfolio {\n  margin: 10px 0;\n  display: flex;\n}\n\nbody div a {\n  margin: 0 5px 0 0;\n  justify-content: right;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let PortfolioComponent = class PortfolioComponent {
    ...
    changeGraph() {
        if (this.showGraph === true) {
            ...
            this.chart.config.data.datasets[0].label = 'Portfolio History';
...
/***/ "./src/app/stock-card/stock-card.component.scss":
/*!******************************************************!*\
  !*** ./src/app/stock-card/stock-card.component.scss ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = ".rightBorder {\n  padding-right: 10px;\n  border-right: 1px solid #ccc;\n}\n\ndiv {\n  display: flex;\n  width: 100%;\n}\n\ndiv p {\n  margin: 0 20px 0 0;\n}\n\nbutton {\n  margin: 0 5px 0 0;\n}\n\n@media only screen and (max-width: 992px) {\n  #stockHeader {\n    border-right: 0px;\n  }\n\n  .marginSpace {\n    justify-content: center;\n    margin: 10px 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/stock-card/stock-card.component.ts":
/*!****************************************************!*\
  !*** ./src/app/stock-card/stock-card.component.ts ***!
  \****************************************************/
